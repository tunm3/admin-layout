...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset('css/bootstrap-timepicker.css')}}"/>
    <link rel="stylesheet" href="{{URL::asset('css/basic.css')}}"/>
    <link rel="stylesheet" href="{{URL::asset('css/dropzone.css')}}"/>
    <link rel="stylesheet" href="{{URL::asset('css/bootstrap-markdown.min.css')}}"/>
    <link rel="stylesheet" href="{{URL::asset('css/summernote.css')}}"/>
    <link rel="stylesheet" href="{{URL::asset('css/summernote-bs3.css')}}"/>
    <link rel="stylesheet" href="{{URL::asset('css/codemirror.css')}}"/>
    <link rel="stylesheet" href="{{URL::asset('css/monokai.css')}}"/>
    <link rel="stylesheet" href="{{URL::asset('css/pnotify.custom.css')}}" />
...
<section class="body">
    ...
    <header class="header">
        <div class="logo-container">
            <a href="../" class="logo">
                <img src="{{URL::asset('images/logo.png')}}" height="35" alt="JSOFT Admin"/>
            </a>
                            ...
                            <ul>
                                <li>
                                    <a href="#" class="clearfix">
                                        <figure class="image">
                                            <img src="{{URL::asset('images/!sample-user.jpg')}}" alt="Joseph Doe Junior"
                                                 class="img-circle"/>
                                        </figure>
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <figure class="image">
                                            <img src="{{URL::asset('images/!sample-user.jpg')}}" alt="Joseph Junior"
                                                 class="img-circle"/>
                                        </figure>
                                ...
                                <li>
                                    <a href="#" class="clearfix">
                                        <figure class="image">
                                            <img src="{{URL::asset('images/!sample-user.jpg')}}" alt="Joe Junior"
                                                 class="img-circle"/>
                                        </figure>
            ...
            <div id="userbox" class="userbox">
                <a href="#" data-toggle="dropdown">
                    <figure class="profile-picture">
                        <img src="{{URL::asset('images/!logged-user.jpg')}}" alt="Joseph Doe" class="img-circle"
                             data-lock-picture="{{URL::asset('images/!logged-user.jpg')}}"/>
                    </figure>
...
<script src="{{URL::asset('js/jquery.browser.mobile.js')}}"></script>
<script src="{{URL::asset('js/bootstrap.js')}}"></script>
<script src="{{URL::asset('js/nanoscroller.js')}}"></script>
...
<script src="{{URL::asset('js/jquery-ui-1.10.4.custom.js')}}"></script>
...
<script src="{{URL::asset('js/jquery.easypiechart.js')}}"></script>
<script src="{{URL::asset('js/jquery.flot.js')}}"></script>
<script src="{{URL::asset('js/jquery.flot.tooltip.js')}}"></script>
<script src="{{URL::asset('js/jquery.flot.pie.js')}}"></script>
<script src="{{URL::asset('js/jquery.flot.categories.js')}}"></script>
...
<script src="{{URL::asset('js/liquid.meter.js')}}"></script>
...
<script src="{{URL::asset('js/jquery.vmap.africa.js')}}"></script>
<script src="{{URL::asset('js/jquery.vmap.asia.js')}}"></script>
<script src="{{URL::asset('js/jquery.vmap.australia.js')}}"></script>
<script src="{{URL::asset('js/jquery.vmap.europe.js')}}"></script>
<script src="{{URL::asset('js/jquery.vmap.north-america.js')}}"></script>
<script src="{{URL::asset('js/jquery.vmap.south-america.js')}}"></script>
...
<script src="{{URL::asset('js/markdown.js')}}"></script>
<script src="{{URL::asset('js/to-markdown.js')}}"></script>
<script src="{{URL::asset('js/bootstrap-markdown.js')}}"></script>
<script src="{{URL::asset('js/codemirror.js')}}"></script>
<script src="{{URL::asset('js/active-line.js')}}"></script>
<script src="{{URL::asset('js/matchbrackets.js')}}"></script>
<script src="{{URL::asset('js/javascript.js')}}"></script>
<script src="{{URL::asset('js/xml.js')}}"></script>
<script src="{{URL::asset('js/htmlmixed.js')}}"></script>
<script src="{{URL::asset('js/css.js')}}"></script>
<script src="{{URL::asset('js/summernote.js')}}"></script>
<script src="{{URL::asset('js/bootstrap-maxlength.js')}}"></script>
<script src="{{URL::asset('js/ios7-switch.js')}}"></script>
...
<script src="{{URL::asset('js/examples.datatables.default.js')}}"></script>
<script src="{{URL::asset('js/examples.datatables.row.with.details.js')}}"></script>
<script src="{{URL::asset('js/examples.datatables.tabletools.js')}}"></script>
<script src="{{URL::asset('js/examples.advanced.form.js')}}" /></script>
<script src="{{URL::asset('js/examples.calendar.js')}}"></script>
<script src="{{URL::asset('js/examples.modals.js')}}"></script>
</body>
</html>
