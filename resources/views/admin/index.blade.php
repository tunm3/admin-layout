...
@section('title')
    Dashboard | JSOFT Themes | JSOFT-Admin
@endsection
                            ...
                            <header class="panel-heading bg-primary">
                                ...
                                <div class="widget-profile-info">
                                    <div class="profile-picture">
                                        <img src="{{URL::asset('images/!logged-user.jpg')}}">
                                    </div>
                                            ...
                                            <ul class="simple-user-list mb-xlg">
                                                <li>
                                                    <figure class="image rounded">
                                                        <img src="{{URL::asset('images/!sample-user.jpg')}}" alt="Joseph Doe Junior" class="img-circle">
                                                    </figure>
                                                ...
                                                <li>
                                                    <figure class="image rounded">
                                                        <img src="{{URL::asset('images/!sample-user.jpg')}}" alt="Joseph Junior" class="img-circle">
                                                    </figure>
                                                ...
                                                <li>
                                                    <figure class="image rounded">
                                                        <img src="{{URL::asset('images/!sample-user.jpg')}}" alt="Joe Junior" class="img-circle">
                                                    </figure>
                                    ...
                                    <li>
                                        <div class="tm-box">
                                            ...
                                            <div class="thumbnail-gallery">
                                                <a class="img-thumbnail lightbox" href="{{URL::asset('images/project-4.jpg')}}" data-plugin-options='{ "type":"image" }'>
                                                    <img class="img-responsive" width="215" src="{{URL::asset('images/project-4.jpg')}}">
                                                    <span class="zoom">
